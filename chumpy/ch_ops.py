...
class amax(A_extremum):
    def f(self, *args, **kwargs):    return bn.amax(*args, **kwargs)
    def argf(self, *args, **kwargs): return bn.argmax(*args, **kwargs)
    
max = amax    

class amin(A_extremum):
    def f(self, *args, **kwargs):    return bn.amin(*args, **kwargs)
    def argf(self, *args, **kwargs): return bn.argmin(*args, **kwargs)

min = amin

class nanmin(A_extremum):
    def f(self, *args, **kwargs):    return bn.nanmin(*args, **kwargs)
    def argf(self, *args, **kwargs): return bn.nanargmin(*args, **kwargs)

class nanmax(A_extremum):
    def f(self, *args, **kwargs):    return bn.nanmax(*args, **kwargs)
