...
sh_red = SphericalHarmonics(vn=vn, light_color=ch.array([1,0,0]), components=ch.randn(9))
sh_green = SphericalHarmonics(vn=vn, light_color=ch.array([0,1,0]), components=ch.randn(9))
sh_blue = SphericalHarmonics(vn=vn, light_color=ch.array([0,0,1]), components=ch.randn(9))
